...
#define OPERATING_MODE 0    // 系统运行模式切换标志位, 0=调试模式, 1=运行模式
#define SEND_DETAIL 1       // 调试模式下发送详细调试信息 (!OPERATING_MODE)
#define DEBUG_ECHO 1        // 可选调试：1=回显 USART2 RX 原始字节到调试口；0=完全关闭回显
#define CRC_DEBUG_ENABLED 1 // 设置为1启用CRC调试信息，设置为0关闭
//=====================================================
