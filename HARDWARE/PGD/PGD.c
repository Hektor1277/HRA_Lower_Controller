...
const double M[M_ROWS * M_COLS] = {
    ...
    -1.25, -1.25, 1.25, 1.25, 0.0, 0.0, 0.0, 0.0, 1.25, 1.25, -1.25, -1.25,
    1.25, -1.25, -1.25, 1.25, -1.25, 1.25, 1.25, -1.25, 0.0, 0.0, 0.0, 0.0};
...
const double M_pseudo[M_COLS * M_ROWS] = {
    ...
    -0.1000,  0.0000,  0.0000,  0.0000,  0.1000, -0.1000,
     0.1000,  0.0000,  0.0000,  0.0000,  0.1000,  0.1000,
     0.0000, -0.1000,  0.0000,  0.1000,  0.0000, -0.1000,
     0.0000,  0.1000,  0.0000,  0.1000,  0.0000,  0.1000,
     0.0000, -0.1000,  0.0000, -0.1000,  0.0000,  0.1000,
     0.0000,  0.1000,  0.0000, -0.1000,  0.0000, -0.1000,
     0.0000,  0.0000, -0.1000, -0.1000,  0.1000,  0.0000,
     0.0000,  0.0000,  0.1000,  0.1000,  0.1000,  0.0000,
     0.0000,  0.0000, -0.1000,  0.1000, -0.1000,  0.0000,
     0.0000,  0.0000,  0.1000, -0.1000, -0.1000,  0.0000};
